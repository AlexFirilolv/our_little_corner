...
import { acceptLocketInvite } from '@/lib/db'

/**
 * POST /api/locket-invites/[id]/accept - Accept a locket invite
 */
export async function POST(
  ...
  try {
    ...
    const result = await acceptLocketInvite(inviteId, user.uid, user.email || '', user.displayName || '')
