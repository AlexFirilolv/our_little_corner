...
import { Loader2, Heart, Clock, Compass, ChevronRight, ChevronDown, Link2 } from 'lucide-react';
...
export default function HomePage() {
        ...
        if (locketLoading) {
            return (
                <div className="min-h-screen flex items-center justify-center bg-background">
                    <div className="text-center">
                        <Loader2 className="w-10 h-10 animate-spin text-primary mx-auto mb-4" />
                        <p className="text-muted">Loading your locket...</p>
                    </div>
                </div>
            );
        }
        ...
        if (!currentLocket && userLockets.length === 0) {
            ...
            return (
                <div className="min-h-screen flex items-center justify-center bg-background">
                    <div className="text-center">
                        <Loader2 className="w-10 h-10 animate-spin text-primary mx-auto mb-4" />
                        <p className="text-muted">Setting up your locket...</p>
                    </div>
                </div>
            );
        }
    ...
    return (
        <div className="h-screen w-full overflow-hidden bg-background text-foreground font-body antialiased selection:bg-primary selection:text-primary-foreground">
            <div className="h-full w-full flex flex-row md:flex-col overflow-x-auto md:overflow-x-hidden overflow-y-hidden md:overflow-y-auto snap-x md:snap-y snap-mandatory no-scrollbar scroll-smooth">
                ...
                <div className="snap-start w-screen h-screen shrink-0 relative flex items-center justify-center overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-background via-transparent to-background/20 opacity-80"></div>
                    <div className="relative z-10 text-center px-6 max-w-4xl flex flex-col items-center">
                        <div className="flex items-center justify-center gap-3 mb-6">
                            <div className="flex h-16 w-16 items-center justify-center rounded-full bg-primary/20 backdrop-blur-sm text-primary border border-primary/30">
                    ...
                    <div className="absolute right-4 top-1/2 -translate-y-1/2 md:hidden animate-bounce z-20">
                        <ChevronRight className="w-8 h-8 text-faint" />
                    </div>
                    <div className="hidden md:block absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce z-20">
                        <ChevronDown className="w-8 h-8 text-faint" />
                    </div>
                </div>

                {/* Timeline Section */}
                <div className="snap-start w-screen h-screen shrink-0 relative flex items-center justify-center overflow-hidden bg-background">
                    <div className="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-10 blur-sm scale-110" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuBfGZEUHQR6iriogrUa456GIpjsbWO3gQhXcCF9ns4X4Zlw3JfXc5YA0s8hqKqcEEUcsioBfZWtE63MHPYJG8XGFzyvqL0wr4L-Bx6i9g0FTxnsiRmqq6VpNmdTUotPMYXj19Ym6yd8fZvpVFugzBSmy61EJcRb79JF-_n_IXh3TV3g5RPo1bjbpxqeXjOjh46120YCUUWpbL0fHehVrxaFo_7E8y4QdTlJifmpHs9A18b3p5z7hGqZcqleYtpBPdF0rmqmCyshwyA')" }}></div>
                    <div className="relative z-10 w-full max-w-6xl px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        <div className="text-left order-2 md:order-1">
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-accent/10 text-accent text-caption font-bold uppercase tracking-wider mb-6 border border-accent/20">
                        ...
                        <div className="relative h-[500px] flex justify-center items-start pt-12 order-1 md:order-2">
                            ...
                            <div className="flex flex-col gap-12 items-center w-full relative z-10">
                                <div className="flex items-center gap-4 w-full justify-center scale-110">
                                    ...
                                    <div className="w-5 h-5 rounded-full bg-elevated border-4 border-primary shadow-md shrink-0 z-20"></div>
                                    <div className="w-48 bg-elevated p-4 rounded-xl border border-border shadow-md">
                                        <div className="flex gap-2 mb-2">
                                            <div className="h-8 w-8 rounded-full bg-surface-rose flex items-center justify-center text-xs">📸</div>
                                            <div className="flex-1 space-y-1">
                                                <div className="text-caption text-foreground font-medium">Trip to Paris</div>
                                                <div className="h-1.5 w-12 bg-border rounded"></div>
                                            </div>
                                        </div>
                                        <div className="h-24 w-full bg-surface-rose rounded overflow-hidden relative">
                                ...
                                <div className="flex items-center gap-4 w-full justify-center opacity-70">
                                    <div className="w-32 text-right text-faint font-mono text-body-sm">Dec 2023</div>
                                    <div className="w-3 h-3 rounded-full bg-primary shrink-0"></div>
                                    <div className="w-32 bg-elevated p-3 rounded-lg border border-border">
                                        <div className="text-caption text-foreground mb-1">Anniversary</div>
                                ...
                                <div className="flex items-center gap-4 w-full justify-center opacity-40 scale-90">
                                    <div className="w-32 text-right text-faint font-mono text-body-sm">Oct 2021</div>
                                    <div className="w-3 h-3 rounded-full bg-primary shrink-0"></div>
                                    <div className="w-32 bg-elevated p-3 rounded-lg border border-border">
                                        <div className="h-2 w-16 bg-border rounded mb-2"></div>
                                        <div className="h-12 w-full bg-surface-green rounded"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="snap-start w-screen h-screen shrink-0 relative flex items-center justify-center overflow-hidden bg-background">
                    <div className="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-10" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuBfGZEUHQR6iriogrUa456GIpjsbWO3gQhXcCF9ns4X4Zlw3JfXc5YA0s8hqKqcEEUcsioBfZWtE63MHPYJG8XGFzyvqL0wr4L-Bx6i9g0FTxnsiRmqq6VpNmdTUotPMYXj19Ym6yd8fZvpVFugzBSmy61EJcRb79JF-_n_IXh3TV3g5RPo1bjbpxqeXjOjh46120YCUUWpbL0fHehVrxaFo_7E8y4QdTlJifmpHs9A18b3p5z7hGqZcqleYtpBPdF0rmqmCyshwyA')" }}></div>
                    <div className="relative z-10 w-full max-w-6xl px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        <div className="relative h-[450px] w-full bg-elevated rounded-2xl border border-border overflow-hidden shadow-lg flex items-center justify-center group order-2 md:order-1">
                            <div className="absolute inset-0 w-full h-full bg-surface-green grid grid-cols-3 grid-rows-3 opacity-90">
                                {mapTiles.map((tile, i) => (
                                    <img
                                        key={i}
                            ...
                            <div className="absolute top-[38%] left-[58%] -translate-x-1/2 z-10">
                                <div className="relative flex flex-col items-center">
                                    <div className="w-6 h-6 bg-secondary rounded-full border-2 border-white shadow-md"></div>
                                    <div className="absolute -top-8 bg-elevated text-foreground text-caption font-bold px-2 py-1 rounded shadow-md whitespace-nowrap border border-border">Central Park</div>
                                </div>
                            </div>
                            <div className="absolute top-[55%] left-[48%] z-10">
                            ...
                            <div className="absolute bottom-4 left-4 z-20">
                                <div className="flex items-center gap-2 bg-elevated/80 backdrop-blur-md px-3 py-1.5 rounded-lg border border-border shadow-sm">
                                    <Compass className="w-3.5 h-3.5 text-muted" />
                                    <span className="text-caption text-muted font-mono tracking-wide">NYC MAP</span>
                                </div>
                            </div>
                            <div className="absolute bottom-1 right-1 z-20 text-[8px] text-faint opacity-60 px-2 bg-elevated/50 rounded">
                                © Leaflet | © OpenStreetMap | © CARTO
                            </div>
                        </div>
                        <div className="text-left order-1 md:order-2">
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 text-primary text-caption font-bold uppercase tracking-wider mb-6 border border-primary/20">
                ...
                <div className="snap-start w-screen h-screen shrink-0 relative flex items-center justify-center overflow-hidden">
                    ...
                    <div className="relative z-10 w-full max-w-md p-6">
                        <div className="bg-elevated border border-border rounded-2xl shadow-2xl p-8 md:p-10 text-center">
                            <div className="flex flex-col items-center gap-4 mb-8">
                                <div className="flex h-14 w-14 items-center justify-center rounded-full bg-primary/10 text-primary mb-2">
                                    <Heart className="w-7 h-7 fill-current" />
                                </div>
                                <h2 className="font-display text-display text-foreground tracking-tight">Twofold</h2>
                                <p className="text-muted">Your shared world awaits.</p>
                            </div>
                            ...
                            <div className="flex flex-col gap-6">
                                <button
                                    onClick={handleLogin}
                                    disabled={isLoading}
                                    className="group flex w-full cursor-pointer items-center justify-center gap-3 overflow-hidden rounded-lg h-14 px-6 bg-elevated border border-border hover:border-border-emphasis hover:shadow-md text-foreground text-body font-bold transition-all duration-200 active:scale-[0.98] disabled:opacity-50"
                                >
                                    {isLoading ? (
                                ...
                                <div className="relative flex items-center py-2">
                                    ...
                                    <span className="flex-shrink-0 mx-4 text-faint text-caption font-semibold uppercase tracking-wider">Or</span>
                                    <div className="flex-grow border-t border-border"></div>
                                </div>

                                <form onSubmit={handleJoin} className="space-y-3 text-center">
                                    <label className="text-body-sm font-semibold text-foreground" htmlFor="invite-link">Have an invite link?</label>
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full bg-elevated border border-border rounded-lg px-4 py-3.5 pl-11 text-foreground placeholder:text-faint focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all outline-none"
                                        />
                                        <Link2 className="absolute left-3.5 top-4 w-5 h-5 text-faint" />
                                        <button
                                            type="submit"
                                            className="absolute right-2 top-2 bottom-2 bg-primary/10 hover:bg-primary/20 text-primary px-3 rounded-md text-body-sm font-bold transition-colors"
                                        >
                                            Join
                                        </button>
                                    </div>
                            ...
                            <p className="mt-8 text-center text-faint text-body-sm">
